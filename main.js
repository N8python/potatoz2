...
$("#assignFarmer").click(() => {
  if (availableCats > 0) {
    let withdrawAmount = parseNum($("#numFarmerCats").val());
...
$("#assignStudent").click(() => {
  if (availableCats > 0) {
    let withdrawAmount = parseNum($("#numStudentCats").val());
    if(withdrawAmount > availableCats) {
      addMessage("You can't withdraw more than you have!");
      return;
    }
...
$("#assignSurveyor").click(() => {
  if (availableCats > 0) {
    let withdrawAmount = parseNum($("#numSurveyorCats").val());
    if(withdrawAmount > availableCats) {
      addMessage("You can't withdraw more than you have!");
      return;
    }
...
$("#assignSoldier").click(() => {
  if (availableCats > 0) {
    let withdrawAmount = parseNum($("#numSoldierCats").val());
    if(withdrawAmount > availableCats) {
      addMessage("You can't withdraw more than you have!");
      return;
    }
...
$("#assignChaplain").click(() => {
  if (availableCats > 0) {
    let withdrawAmount = parseNum($("#numChaplainCats").val());
    if(withdrawAmount > availableCats) {
      addMessage("You can't withdraw more than you have!");
      return;
    }
...
let consoleId = setInterval(() => {
  if (potatoz > 99 && !doneMessages.includes("patches") && !farmsUnlocked) {
